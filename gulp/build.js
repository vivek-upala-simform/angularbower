...
gulp.task('clean', function() {
    return $.del([path.join(conf.paths.dist, '/'), path.join(conf.paths.tmp, '/'), path.join(conf.paths.deploy, '/')]);
});

gulp.task('build', ['env:dev', 'html', 'fonts', 'other']);
gulp.task('build:dev', ['env:dev', 'html', 'fonts', 'other']);
gulp.task('build:prod', ['env:prod', 'html', 'fonts', 'other']);